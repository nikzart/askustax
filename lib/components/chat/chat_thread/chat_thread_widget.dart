                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    if (widget.chatMessagesRef?.transaction !=
                                        null)
                                      wrapWithModel(
                                        model: _model.initiatePaymentModel1,
                                        updateCallback: () => setState(() {}),
                                        child: InitiatePaymentWidget(
                                          transaction: widget
                                              .chatMessagesRef!.transaction!,
                                        ),
                                      ),
                                  ],
                                ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                if (widget.chatMessagesRef?.transaction !=
                                    null)
                                  wrapWithModel(
                                    model: _model.initiatePaymentModel2,
                                    updateCallback: () => setState(() {}),
                                    child: InitiatePaymentWidget(
                                      transaction:
                                          widget.chatMessagesRef!.transaction!,
                                    ),
                                  ),
                              ],
                            ),
