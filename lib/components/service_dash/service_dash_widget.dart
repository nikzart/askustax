...
class ServiceDashWidget extends StatefulWidget {
  const ServiceDashWidget({super.key});

  @override
  State<ServiceDashWidget> createState() => _ServiceDashWidgetState();
}

class _ServiceDashWidgetState extends State<ServiceDashWidget> {
  late ServiceDashModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ServiceDashModel());
            ...
            child: StreamBuilder<List<ServicesRecord>>(
              stream: queryServicesRecord(
                queryBuilder: (servicesRecord) =>
                    servicesRecord.orderBy('isActive', descending: true),
              ),
                                  ...
                                  children: [
                                    RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: listViewServicesRecord.name,
                                            style: TextStyle(
                                              color:
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        height: 32.0,
                                        decoration: BoxDecoration(
                                          color: listViewServicesRecord.isActive
                                              ? FlutterFlowTheme.of(context)
                                                  .accent1
                                              : FlutterFlowTheme.of(context)
                                                  .accent5,
                                          ...
                                          child: Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    7.0, 0.0, 7.0, 0.0),
                                            child: Text(
                                              listViewServicesRecord.isActive
                                                  ? 'Active'
                                                  : 'Inactive',
                                              style:
                                                  FlutterFlowTheme.of(context)
