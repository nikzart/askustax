...
import 'update_pass_model.dart';
export 'update_pass_model.dart';

class UpdatePassWidget extends StatefulWidget {
  ...
  @override
  State<UpdatePassWidget> createState() => _UpdatePassWidgetState();
}

class _UpdatePassWidgetState extends State<UpdatePassWidget>
    with TickerProviderStateMixin {
  late UpdatePassModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdatePassModel());
            ...
            children: [
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.passChangeState = await actions.changePassword(
                    ...
                    if (_model.passChangeState ==
                        'Password changed successfully.') {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            _model.passChangeState!,
                            style: TextStyle(
