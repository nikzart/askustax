...
class _MetricsWidgetState extends State<MetricsWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await Future.wait([
        Future(() async {
          _model.clientCount = await queryUsersRecordCount(
        ...
        Future(() async {
          _model.caCount = await queryUsersRecordCount(
            queryBuilder: (usersRecord) => usersRecord.where(
              'is_CA',
              isEqualTo: true,
            ),
        ...
        Future(() async {
          _model.revenueGraph = await actions.revenueStats(
            7,
          );
        }),
        Future(() async {
          _model.signupsGraph = await actions.signupStats(
            7,
          );
        }),
      ]);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<RecordsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RecordsRecord> metricsRecordsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final metricsRecordsRecord = metricsRecordsRecordList.isNotEmpty
            ? metricsRecordsRecordList.first
            : null;
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  'Below is the platform overview',
                                                                ...
                                                                child: Padding(
                                                                  padding: const EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                                  child: Text(
                                                                    '₹ ${metricsRecordsRecord?.totalRevenue.toString()}',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .displaySmall
                                                                        .override(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                'New sign up trends in the last 7 days.',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .labelMedium
                                                                    .override(
